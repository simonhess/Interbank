 ...
 *
 */
public class CBBankRateComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			...
			result.put(cb.getAgentId(), cb.getReserveInterestRate());
		}
		return result;
	}
